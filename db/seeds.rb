...
itinerary.events.create!(title: 'Drink at the Pub', date: 'June-02-2015', location: 'Ireland', start_time: '1:00 PM', end_time: '3:00 PM', attendees: 'Paul, Ralph, Josh, Joe', desc: 'Drink good beer and eat corned beed and hash')
puts "Paul Itinerary inserted"

##### Itinerary 2: Roger
itinerary = roger.itineraries.create!(name: 'Neals Bachelor Party')
itinerary.events.create!(title: 'Bowling', date: '10-11-2015', location: 'Vegas Strip', start_time: '12:00', end_time: '03:00', attendees: 'Neal, Roger, Max, Joe, Steve', desc: 'Roll it straight')
itinerary.events.create!(title: 'Dinner at Steakhouse', date: '10-12-2015', location: 'Al\'s Steakhouse', start_time: '4:00 PM', end_time: '7:00 PM', attendees: 'Neal, Roger, Max, Joe, Steve', desc: 'Drink good wine and eat steak')
